...
export const translations: Record<AppLanguage, TranslationDictionary> = {
  en: {
    ...
    nav_landing_settings: 'Landing Page Settings',
  ...
  ceb: {
    ...
    nav_takeoff: 'Andam Na Ibaligya (Take-Off)',
    ...
    nav_landing_settings: 'Setting sa Publikong Portal',
    nav_form_customizer: 'Pagpahaom sa Porma sa Rehistro',
    nav_sidebar_config: 'Pag-ayos sa Kolor ug Logo sa Sidebar',
    nav_public_portal: 'Tan-awa ang Publikong Portal',
    nav_sign_out: 'Paggawas (Sign Out)',
    nav_system_admin: 'Pagdumala sa Sistema (Admin)',
